...
Roof::Roof(int x, int y, int width, int height, string type)
{
	...
	Sprite * sprite = new Sprite(L"Resources\\GameItem\\apple.png", rect, ROOF_TEXTURE_TRANS_COLOR);
