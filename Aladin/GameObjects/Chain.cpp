...
Chain::Chain(int x, int y, int width, int height, string type)
{
	this->x = x;
	...
	Sprite * sprite = new Sprite(L"Resources\\GameItem\\apple.png", rect, CHAIN_TEXTURE_TRANS_COLOR);
