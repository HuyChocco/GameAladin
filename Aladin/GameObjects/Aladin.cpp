...
Aladin::Aladin()
{
	...
	jumpState = new AladinState(this, ALADIN_ANI_JUMP);
...
{
	this->SetStateNumber(ALADIN_ANI_JUMP);
	return jumpState;
}
...
void Aladin::StandHit()
{
	state->StandHit();
}

void Aladin::CrouchHit()
{
	state->CrouchHit();
}

void Aladin::SitOnShield()
{
	state->SitOnShield();
}
